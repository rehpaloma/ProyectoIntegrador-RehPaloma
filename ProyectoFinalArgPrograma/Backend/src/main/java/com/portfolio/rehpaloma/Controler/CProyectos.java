package com.portfolio.rehpaloma.Controler;

import com.portfolio.rehpaloma.Dto.dtoProyectos;
import com.portfolio.rehpaloma.Entity.Proyectos;
import com.portfolio.rehpaloma.Security.Controller.Mensaje;
import com.portfolio.rehpaloma.Service.SProyectos;
...
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproyectos){
        ...
        Proyectos proyectos = new Proyectos(
                dtoproyectos.getNombreP(), dtoproyectos.getDescripcionP(), dtoproyectos.getImgP()
            );
